...
one wall of the enclosure. A new sona signal is acquired every $t_{c}=39.8$~seconds,
leading to a dead time of duration $t_{d}=7$~seconds. The target is moving at a speed
