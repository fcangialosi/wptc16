...
The proposed TR WPT system has three basic components. The first is a rectenna that serves as the receiver of the WPT system. ~\cite{nltr-wave-chaotic} and ~\cite{ROMAN} \todo{Fix citations. Are we allowed to cite Scott?} demonstrate how individual receivers in a group can be focused on.
